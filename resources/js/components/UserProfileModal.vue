<template>
    <div v-if="user" style="z-index: 99999" class="modal fade modal-profile" id="user-modal-profile" data-backdrop="true">
                                                    ...
                                                    <div style="height:158px;background:#514a38" class="item-description">
                                                        ...
                                                        <div class="row row-sm p-3">
                                                            <div v-for="(gear,index) in user.gears" :key="index" style="margin-bottom:15px" class="col-3 d-flex" data-title="tooltip" title="Click để xem chi tiết" >
                                                                <div class="flex">
                                                                    <div @click="$parent.showGearsDescription(gear, 0)" style="background-color: #2f2d21;border-radius: 50%;" :class="[`pixel text-center ${gear.shop_tag}`]">
                                        ...
                                        <div class="stats-preview">
                                            ...
                                            <div class="item">
                                                <div class="flex">
                                                    ...
                                                    <div @click="$parent.notify(`${user.infor.name} cần ${$parent.numberFormatDetail(user.level.next_level_exp - user.level.current_user_exp)} kinh nghiệm nữa để lên cấp`)" class="progress my-3 circle" style="height:12px;border-radius:0px;">
                                                        <div class="progress-bar pixel-font" style="background:#ffdd44;border-radius:0px;color:#333;height:12px" data-title="tooltip" :title="`${user.infor.name} cần ${$parent.numberFormatDetail(user.level.next_level_exp - user.level.current_user_exp)} kinh nghiệm nữa để lên cấp`" :style="{width:user.level.percent + '%'}">
