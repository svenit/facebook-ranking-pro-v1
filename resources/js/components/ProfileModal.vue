                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-12 mb-3">
                                                    <div class="row">
                                                        <div class="col-3 pr-0">
                                                            ...
                                                            <img style="width:60px" class="circle mr-3" :src="`http://graph.facebook.com/${data.infor.provider_id}/picture?type=normal`" alt="...">
                                                        </div>
                                                            ...
                                                            <div class="row justify-content-between">
                                                                ...
                                                                <div style="background:#524a3a;border-radius:3px" class="col-8">
                                                                    <span style="font-size:12px" class="pixel-font text-warning">
                                                                        {{ $parent.numberFormatDetail(data.infor.fame) }}
                                                                    </span>
                                                                    <img class="pixel" data-title="tooltip" title="Xem thông tin chi tiết" style="float: right;top:3px;position: relative;" data-dismiss="modal" data-toggle="modal" data-target=".modal-fame" data-toggle-class="modal-open-aside" width="18px" :src="asset('assets/images/icon/Question.png')">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="item-preview" style="height: 222px;">
                                                    ...
                                                    <div style="margin:30px auto;position:relative;right:-15px;transform:scaleX(-1)" class="character-sprites hoverable">
                                                        ...
                                                        <span v-for="(gear,index) in data.gears" :key="index">
                                                            <span v-if="gear.class_tag.includes(' ')"><span v-for="(e, i) in gear.class_tag.split(' ')" :key="i" :class="`${e} ${gear.cates.animation} up-to-down`" :style="{zIndex:gear.cates.z_index}"></span></span>
                                                    ...
                                                    <div style="height:158px;background:#514a38" class="item-description">
                                                        ...
                                                        <div class="row row-sm p-3">
                                                            <div v-for="(gear,index) in data.gears" :key="index" style="margin-bottom:15px" class="col-3 d-flex" data-title="tooltip" title="Click để xem chi tiết" >
                                                                <div class="flex">
                                                                    <div @click="$parent.showGearsDescription(gear,1)" style="background-color: #2f2d21;border-radius: 50%;" :class="[`pixel text-center ${gear.shop_tag}`]">
                                        ...
                                        <div class="stats-preview">
                                            ...
                                            <div class="item">
                                                <div class="flex">
                                                    ...
                                                    <div @click="$parent.notify(`Bạn cần ${$parent.numberFormatDetail(data.level.next_level_exp - data.level.current_user_exp)} kinh nghiệm nữa để lên cấp`)" class="progress my-3 circle" style="height:12px;border-radius:0px;">
                                                        <div class="progress-bar pixel-font" style="background:#ffdd44;border-radius:0px;color:#333;height:12px" data-title="tooltip" :title="`Bạn cần ${$parent.numberFormatDetail(data.level.next_level_exp - data.level.current_user_exp)} kinh nghiệm nữa để lên cấp`" :style="{width:data.level.percent + '%'}">
                                                ...
                                                <div class="flex">
                                                    <div class="text-silver row justify-content-between">
                                                        ...
                                                        <div class="col-auto">
                                                            ...
                                                            <img @click="$parent.incrementStat('health_points')" style="width:17px" class="ml-2" :src="asset('assets/images/icon/Add.png')">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="flex">
                                                    <div class="text-silver row justify-content-between">
                                                        ...
                                                        <div class="col-auto">
                                                            ...
                                                            <img @click="$parent.incrementStat('strength')" style="width:17px" class="ml-2" :src="asset('assets/images/icon/Add.png')">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="flex">
                                                    <div class="text-silver row justify-content-between">
                                                        ...
                                                        <div class="col-auto">
                                                            ...
                                                            <img @click="$parent.incrementStat('intelligent')" style="width:17px" class="ml-2" :src="asset('assets/images/icon/Add.png')">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="flex">
                                                    <div class="text-silver row justify-content-between">
                                                        ...
                                                        <div class="col-auto">
                                                            ...
                                                            <img @click="$parent.incrementStat('agility')" style="width:17px" class="ml-2" :src="asset('assets/images/icon/Add.png')">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="flex">
                                                    <div class="text-silver row justify-content-between">
                                                        ...
                                                        <div class="col-auto">
                                                            ...
                                                            <img @click="$parent.incrementStat('lucky')" style="width:17px" class="ml-2" :src="asset('assets/images/icon/Add.png')">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="flex">
                                                    <div class="text-silver row justify-content-between">
                                                        ...
                                                        <div class="col-auto">
                                                            ...
                                                            <img @click="$parent.incrementStat('armor_strength')" style="width:17px" class="ml-2" :src="asset('assets/images/icon/Add.png')">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="flex">
                                                    <div class="text-silver row justify-content-between">
                                                        ...
                                                        <div class="col-auto">
                                                            ...
                                                            <img @click="$parent.incrementStat('armor_intelligent')" style="width:17px" class="ml-2" :src="asset('assets/images/icon/Add.png')">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
