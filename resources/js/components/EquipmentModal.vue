            ...
            <div style="position: relative;" class="lighting-box modal-content">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="item-preview">
                                            ...
                                            <img style="position: absolute; right: 5%;width: 40px" class="pixel" :src="$parent.asset('assets/images/icon/Dark-Badge.png')">
                                            ...
                                            <div style="margin:42px auto;background-color: #554334;border-radius: 50%;" :class="[`pixel text-center ${detailGear.data.shop_tag}`]">
                                                <img class="pixel" style="width: 70px;" :src="$parent.asset('assets/images/icon/Equipment-Frame.png')">
                                            </div>
                                            <div v-if="detailGear.permission == 1" class="normal-badge">
                                                <img class="pixel" :src="$parent.asset('assets/images/icon/Normal-Badge.png')">
                                            ...
                                            <div class="footer">
                                                <div style="font-size:15px" class="modal-text item-name modal-title text-md text-center">
                                                    <img style="width:17px; height:17px;transform:scaleX(-1)" class="mr-1 pixel" :src="$parent.asset('assets/images/icon/Bar.png')">
                                                    {{ detailGear.data.name }}
                                                    <img style="width:17px; height:17px" class="ml-1 pixel" :src="$parent.asset('assets/images/icon/Bar.png')">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 mt-2">
                                        <div class="item-description">
                                            <border></border>
                                            <img style="width:50px;display:block;margin:10px auto" :src="$parent.asset('assets/images/icon/Border-Top.png')">
                                    ...
                                    <div class="item mt-2">
                                        <div class="row mx-1" v-if="detailGear.permission == 1">
                                            <div v-for="(gem, index) in detailGear.data.gems" :key="index" style="padding:5px" class="col-auto">
                                                <div data-dismiss="modal" style="background-color: #554334;border-radius: 50%;" @click="$parent.showGem(gem, detailGear.permission)" :class="`gem ${gem.gem_item.image}`">
                                                    <img class="pixel" style="width: 50px;" :src="$parent.asset('assets/images/icon/Gem-Frame.png')">
                                                </div>
                                            </div>
                ...
                <div class="modal-footer">
                    <div class="row" v-if="detailGear.permission == 1">
                        <div data-dismiss="modal" v-if="detailGear.data.pivot.status == 0" type="button" @click="$parent.equipment(detailGear.data)" class="btn-green pixel-btn mr-4" >
                            Trang bị <img style="width:16px" :src="$parent.asset('assets/images/icon/Equip.png')">
                        </div>
                        <div data-dismiss="modal" v-else type="button" @click="$parent.removeEquipment(detailGear.data)" class="btn-yellow pixel-btn mr-4">
                            Tháo <img style="width:16px" :src="$parent.asset('assets/images/icon/Unequip.png')">
                        </div>
                        <div data-dismiss="modal" @click="$parent.deleteEquipment(detailGear.data)" class="btn-red pixel-btn mr-3">
                            Vứt Bỏ <img style="width:16px" :src="$parent.asset('assets/images/icon/Delete.png')">
                        </div>
                    </div>
