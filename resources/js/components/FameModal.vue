                                ...
                                <ul class="nav" id="myTab" role="tablist">
                                    <li data-title="tooltip" title="Danh Tiếng" class="nav-item">
                                        <a class="nav-link active" id="fame-tab" data-toggle="tab" href="#fame-tab-control" role="tab" aria-controls="" aria-selected="true">
                                            <img class="text-center" style="width:20px;height:20px;object-fit:contain" :src="$parent.asset('assets/images/icon/Gold-Award.png')">
                                        </a>
                                    </li>
                                    <li @click="$parent.loadUserUtil('all-fames', true)" data-title="tooltip" title="Thông Tin" class="nav-item">
                                        <a class="nav-link" id="fame-info-tab" data-toggle="tab" href="#fame-info-tab-control" role="tab" aria-controls="" aria-selected="true">
                                            <img class="text-center" style="width:20px;height:20px;object-fit:contain" :src="$parent.asset('assets/images/icon/Infor.png')">
                                        </a>
                                    </li>
                                </ul>
                            </div>
                                        ...
                                        <div style="background: #33301d" class="item-preview">
                                            ...
                                            <div class="row p-3">
                                                <div class="col-lg-2 col-md-2 col-sm-12 text-center mb-3">
                                                    ...
                                                    <img style="width:60px" class="circle" :src="`http://graph.facebook.com/${data.infor.provider_id}/picture?type=normal`" alt="...">
                                                </div>
                                                ...
                                                <div class="col-12 mt-3">
                                                    <div class="row justify-content-center">
                                                        <div class="col-lg-2 col-md-3 col-sm-3 pixel-font small-font text-warning text-center-inside">
                                                            {{ $parent.numberFormatDetail(data.rank.fame.point) }}
                                                        </div>
                                                        <div class="col-lg-8 col-md-6 col-sm-6">
                                                            <div @click="$parent.notify(`Bạn cần ${$parent.numberFormatDetail(data.rank.fame.next.point - data.infor.fame > 0 ? data.rank.fame.next.point - data.infor.fame : 0)} điểm nữa để lên cấp`)" class="progress my-3 circle" style="height:6px;border-radius:0px;">
                                                                <div class="progress-bar pixel-font" style="background:#ffdd44;border-radius:0px;color:#333;height:6px" data-title="tooltip" :title="`Bạn cần ${$parent.numberFormatDetail(data.rank.fame.next.point - data.infor.fame > 0 ? data.rank.fame.next.point - data.infor.fame : 0)} điểm nữa để lên cấp`" :style="{width: $parent.getFamePercent() + '%'}"></div>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-2 col-md-3 col-sm-3 pixel-font small-font text-warning text-center-inside">
                                                            {{ $parent.numberFormatDetail(data.rank.fame.next.point) }}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="px-3 py-0 col-12">
                                        <div style="background: #33301d" class="item-preview">
                                            ...
                                            <div style="max-height:350px;overflow:auto" class="row px-4 py-2">
                                                <div v-for="(fame, index) in $parent.userUtil" :key="index" class="col-ui softlight-item item" :class="{'special-item': fame.icon == data.rank.fame.icon}">
                                                    ...
                                                    <div class="pixel-font text-warning small-font pixel-btn m-3 btn-dark mt-5 text-center" style="padding:6px">
                                                        {{ $parent.numberFormatDetail(fame.point) }}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
