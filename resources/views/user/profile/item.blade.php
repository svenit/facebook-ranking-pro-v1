    ...
    <div class="page-content page-container" id="page-content">
        <div class="padding-x">
            ...
            <div class="vip-bordered row">                    
                <div style="padding:20px" v-if="items.length > 0" v-for="(item,index) in items" :key="index" class="hoverable col-auto" data-title="tooltip" title="Click vào để sử dụng" @click="showInforItem(item,1)">
