...
@section('hero','Top Kim Cương')
@section('sub_hero','Top kim cương toàn server ')
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th style="" data-field="task">
                                            <div class="th-inner text-gold"><span class="d-none d-sm-block">Kim Cương</span>
                                            </div>
                                        </th>
                                    </tr>
                                </thead>
                                    ...
                                    @foreach($ranks as $key => $rank)
                                        <tr onclick="showInfor({{ $rank->id }})" class="{{ Auth::check() && Auth::id() == $rank->id ? 'bg-secondary' : '' }}">
                                            ...
                                            <td class="flex" style=""><a href="#"
                                                class="item-title d-none d-sm-block text-color text-danger">{{ number_format($rank->gold) }}</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
