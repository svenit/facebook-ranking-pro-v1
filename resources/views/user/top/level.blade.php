                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th style="" data-field="task">
                                            <div class="th-inner text-gold"><span class="d-none d-sm-block">Exp</span>
                                            </div>
                                        </th>
                                        <th style="" data-field="task">
                                            <div class="th-inner text-gold"><span class="d-none d-sm-block">Level</span>
                                            </div>
                                        </th>
                                    </tr>
                                </thead>
                                    ...
                                    @foreach($ranks as $key => $rank)
                                        <tr @click="showUserInfor({{ $rank->id }})" class="{{ Auth::check() && Auth::id() == $rank->id ? 'bg-secondary' : '' }}">
                                            ...
                                            <td class="flex" style=""><a href="#"
                                                class="item-title d-none d-sm-block text-color text-danger">{{ number_format($rank->exp) }}</a>
                                            </td>
                                            <td class="flex" style=""><a href="#"
                                                class="item-title d-none d-sm-block text-color text-danger">{{ $rank->level() }}</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
