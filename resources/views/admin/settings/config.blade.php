                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="POST" action="{{ Route('admin.pets.store') }}" class="row">
                                            ...
                                            <div class="form-group col-6">
                                                ...
                                                <input type="number" min="0" value="{{ $config->limit_pvp_time }}" class="form-control" name="name" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="">
                                            </div>
                                            <div class="form-group col-6">
                                                <label class="text-muted" for="exampleInputEmail1">ID Nhóm</label>
                                                <input type="number" value="{{ $config->group_id }}" class="form-control" name="name" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="">
                                            </div>
                                            <div class="form-group col-6">
                                                <label class="text-muted" for="exampleInputEmail1">Ngày Bắt Đầu</label>
                                                <input type="date" value="{{ $config->started_day }}" class="form-control" name="name" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="">
                                            </div>
                                            <div class="form-group col-6">
                                                <label class="text-muted" for="exampleInputEmail1">Điểm Bài Viết</label>
                                                <input type="number" value="{{ $config->per_post }}" class="form-control" name="name" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="">
                                            </div>
                                            <div class="form-group col-6">
                                                <label class="text-muted" for="exampleInputEmail1">Điểm Bình Luận</label>
                                                <input type="number" value="{{ $config->per_comment }}" class="form-control" name="name" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="">
                                            </div>
                                            <div class="form-group col-6">
                                                <label class="text-muted" for="exampleInputEmail1">Điểm Được Bình Luận</label>
                                                <input type="number" value="{{ $config->per_commented }}" class="form-control" name="name" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="">
                                            </div>
                                            <div class="form-group col-6">
                                                <label class="text-muted" for="exampleInputEmail1">Điểm Biểu Cảm</label>
                                                <input type="number" value="{{ $config->per_react }}" class="form-control" name="name" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="">
                                            </div>
                                            <div class="form-group col-6">
                                                <label class="text-muted" for="exampleInputEmail1">Điểm Được Biểu Cảm</label>
                                                <input type="number" value="{{ $config->per_reacted }}" class="form-control" name="name" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="">
                                            </div>
                                            <div class="form-group col-12">
                                                <label class="text-muted" for="exampleInputEmail1">Access Token</label>
                                                <input type="text" value="{{ $config->access_token }}" class="form-control" name="name" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="">
                                            </div>
                                            <div class="form-group col-12">
