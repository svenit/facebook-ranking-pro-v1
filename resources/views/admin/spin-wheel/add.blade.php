                    ...
                    <div class="tab-content p-3">
                        <div class="tab-pane active show" id="home-add" role="tabpanel" aria-labelledby="add-tab">
                            <div>
                                <div class="card">
                                    <div class="card-body">
                                        <form method="POST" action="{{ Route('admin.events.store') }}" class="row">
                                            @csrf
                                            <div class="form-group col-6">
                                                <label class="text-muted" for="exampleInputEmail1">Giá Trị</label>
                                                <input type="text" value="" class="form-control" name="value" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="">
                                            </div>
                                            <div class="form-group col-6">
                                            ...
                                            <div class="form-group col-6">
                                                ...
                                                <input type="number" value="" class="form-control" name="probability" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="">
                                            </div>
                                            <div class="form-group col-6">
                                                <label class="text-muted" for="exampleInputEmail1">Lời Hiển Thị</label>
                                                <input type="text" value="" class="form-control" name="result_text" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="">
                                            </div>
                                            <div class="form-group col-12">
                                                <label class="text-muted" for="exampleInputEmail1">SQL Query</label>
                                                <textarea rows="4" class="form-control" name="query"></textarea>
                                            </div>
                                            <div class="form-group col-12">
