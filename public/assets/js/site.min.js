! function (e, t) {
    ...
    function g(e, t) {
        for (var n, i, r = [], o = 0, s = e.length; o < s; o++)(i = e[o]).style && (n = i.style.display, t ? ("none" === n && (r[o] = Ie.get(i, "display") || null, r[o] || (i.style.display = "")), "" === i.style.display && ze(i) && (r[o] = m(i))) : "none" !== n && (r[o] = "none", Ie.set(i, "display", n)));
    ...
    function b(e, t, n, i, r) {
        ...
        for (p.textContent = "", h = 0; o = f[h++];)
            ...
            else if (c = de.contains(o.ownerDocument, o), s = v(p.appendChild(o), "script"), c && x(s), n)
            for (u = 0; o = s[u++];) $e.test(o.type || "") && n.push(o);
        return p
    }
    ...
    function A(e, t) {
        ...
        if (1 === t.nodeType) {
            if (Ie.hasData(e) && (o = Ie.access(e), s = Ie.set(t, o), c = o.events)) {
                ...
                for (r in c)
                    for (n = 0, i = c[r].length; n < i; n++) de.event.add(t, r, c[r][n])
            }
    ...
    function O(e, t, i, r) {
        ...
        var o, s, a, l, c, u, p = 0,
            ...
            d = t[0],
            y = de.isFunction(d);
        if (y || f > 1 && "string" == typeof d && !fe.checkClone && tt.test(d)) return e.each(function (n) {
            var o = e.eq(n);
        ...
        if (f && (o = b(t, e[0].ownerDocument, !1, e, r), s = o.firstChild, 1 === o.childNodes.length && (o = s), s || r)) {
            ...
            if (l)
                for (u = a[a.length - 1].ownerDocument, de.map(a, S), p = 0; p < l; p++) c = a[p], $e.test(c.type || "") && !Ie.access(c, "globalEval") && de.contains(u, c) && (c.src ? de._evalUrl && de._evalUrl(c.src) : n(c.textContent.replace(it, ""), u))
        }
        return e
    }
    ...
    function D(e, t, n) {
        ...
        return (n = n || st(e)) && ("" !== (s = n.getPropertyValue(t) || n[t]) || de.contains(e.ownerDocument, e) || (s = de.style(e, t)), !fe.pixelMarginRight() && ot.test(s) && rt.test(t) && (i = a.width, r = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = r, a.maxWidth = o)), void 0 !== s ? s + "" : s
    }
    ...
    function P(e, t, n, i, r) {
        var o, s = 0;
        for (o = n === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0; o < 4; o += 2) "margin" === n && (s += de.css(e, n + Fe[o], !0, r)), i ? ("content" === n && (s -= de.css(e, "padding" + Fe[o], !0, r)), "margin" !== n && (s -= de.css(e, "border" + Fe[o] + "Width", !0, r))) : (s += de.css(e, "padding" + Fe[o], !0, r), "padding" !== n && (s += de.css(e, "border" + Fe[o] + "Width", !0, r)));
        return s
    }
    ...
    function q(e, t, n) {
        ...
        return ot.test(o) ? o : (i = s && (fe.boxSizingReliable() || o === e.style[t]), "auto" === o && (o = e["offset" + t[0].toUpperCase() + t.slice(1)]), (o = parseFloat(o) || 0) + P(e, t, n || (s ? "border" : "content"), i, r) + "px")
    }
    ...
    function V(e, t, n) {
        ...
        for (B(u, c.opts.specialEasing); o < s; o++)
            if (i = V.prefilters[o].call(c, e, u, c.opts)) return de.isFunction(i.stop) && (de._queueHooks(c.elem, c.opts.queue).stop = de.proxy(i.stop, i)), i;
        return de.map(u, U, c), de.isFunction(c.opts.start) && c.opts.start.call(e, c), c.progress(c.opts.progress).done(c.opts.done, c.opts.complete).fail(c.opts.fail).always(c.opts.always), de.fx.timer(de.extend(l, {
            elem: e,
            anim: c,
            queue: c.opts.queue
        })), c
    ...
    function X(e, t, n, i) {
        var r;
        if (Array.isArray(t)) de.each(t, function (t, r) {
    ...
    de.fn = de.prototype = {
        ...
        for ("boolean" == typeof s && (c = s, s = arguments[a] || {}, a++), "object" == typeof s || de.isFunction(s) || (s = {}), a === l && (s = this, a--); a < l; a++)
            if (null != (e = arguments[a]))
                for (t in e) n = s[t], i = e[t], s !== i && (c && i && (de.isPlainObject(i) || (r = Array.isArray(i))) ? (r ? (r = !1, o = n && Array.isArray(n) ? n : []) : o = n && de.isPlainObject(n) ? n : {}, s[t] = de.extend(c, o, i)) : void 0 !== i && (s[t] = i));
        return s
    }, de.extend({
    ...
    var xe = function (e) {
        function t(e, t, n, i) {
            var r, o, s, a, l, u, f, h = t && t.ownerDocument,
                d = t ? t.nodeType : 9;
        ...
        function m(e, t, n, r, o, s) {
            return r && !r[q] && (r = m(r)), o && !o[q] && (o = m(o, s)), i(function (i, s, a, l) {
                var c, u, p, f = [],
                    ...
                    x = n ? o || (i ? e : m || r) ? [] : s : v;
                if (n && n(v, x, a, l), r)
                    for (c = y(x, h), r(c, [], a, l), u = c.length; u--;)(p = c[u]) && (x[h[u]] = !(v[h[u]] = p));
                if (i) {
                    if (o || e) {
                        if (o) {
                ...
                if (n = w.relative[e[a].type]) u = [f(h(u), n)];
                    ...
                    if ((n = w.filter[e[a].type].apply(null, e[a].matches))[q]) {
                        ...
                        return m(a > 1 && h(u), a > 1 && p(e.slice(0, a - 1).concat({
                            value: " " === e[a - 2].type ? "*" : ""
                        })).replace(oe, "$1"), n, a < i && g(e.slice(a, i)), i < r && g(e = e.slice(i)), i < r && p(e))
                    }
                    u.push(n)
                } return h(u)
        }
        ...
        var x, b, w, _, E, T, C, j, S, A, k, O, N, D, M, I, L, H, P, q = "sizzle" + 1 * new Date,
            R = e.document,
            F = 0,
            z = 0,
            W = n(),
        ...
        b = t.support = {}, E = t.isXML = function (e) {
            ...
            return i !== N && 9 === i.nodeType && i.documentElement ? (N = i, D = N.documentElement, M = !E(N), R !== N && (n = N.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", we, !1) : n.attachEvent && n.attachEvent("onunload", we)), b.attributes = r(function (e) {
                return e.className = "i", !e.getAttribute("className")
            }), b.getElementsByTagName = r(function (e) {
                return e.appendChild(N.createComment("")), !e.getElementsByTagName("*").length
            }), b.getElementsByClassName = de.test(N.getElementsByClassName), b.getById = r(function (e) {
            ...
            }, L = [], I = [], (b.qsa = de.test(N.querySelectorAll)) && (r(function (e) {
            ...
            })), (b.matchesSelector = de.test(H = D.matches || D.webkitMatchesSelector || D.mozMatchesSelector || D.oMatchesSelector || D.msMatchesSelector)) && r(function (e) {
                b.disconnectedMatch = H.call(e, "*"), H.call(e, "[s!='']:x"), L.push("!=", ie)
            }), I = I.length && new RegExp(I.join("|")), L = L.length && new RegExp(L.join("|")), t = de.test(D.compareDocumentPosition), P = t || de.test(D.contains) ? function (e, t) {
                ...
                return n || (1 & (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !b.sortDetached && t.compareDocumentPosition(e) === n ? e === N || e.ownerDocument === R && P(R, e) ? -1 : t === N || t.ownerDocument === R && P(R, t) ? 1 : A ? J(A, e) - J(A, t) : 0 : 4 & n ? -1 : 1)
            } : function (e, t) {
                if (e === t) return k = !0, 0;
                var n, i = 0,
                    r = e.parentNode,
            ...
            if ((e.ownerDocument || e) !== N && O(e), n = n.replace(le, "='$1']"), b.matchesSelector && M && !B[n + " "] && (!L || !L.test(n)) && (!I || !I.test(n))) try {
                var i = H.call(e, n);
            ...
            filter: {
                ...
                CHILD: function (e, t, n, i, r) {
                    ...
                    return 1 === i && 0 === r ? function (e) {
                        ...
                        var c, u, p, f, h, d, y = o !== s ? "nextSibling" : "previousSibling",
                            m = t.parentNode,
                        ...
                        if (m) {
                            ...
                            if (d = [s ? m.firstChild : m.lastChild], s && v) {
                                for (x = (h = (c = (u = (p = (f = m)[q] || (f[q] = {}))[f.uniqueID] || (p[f.uniqueID] = {}))[e] || [])[0] === F && c[1]) && c[2], f = h && m.childNodes[h]; f = ++h && f && f[y] || (x = h = 0) || d.pop();)
                                ...
                                for (;
                                    (f = ++h && f && f[y] || (x = h = 0) || d.pop()) && ((a ? f.nodeName.toLowerCase() !== g : 1 !== f.nodeType) || !++x || (v && (p = f[q] || (f[q] = {}), u = p[f.uniqueID] || (p[f.uniqueID] = {}), u[e] = [F, x]), f !== t)););
        ...
        }, b.sortStable = q.split("").sort(V).join("") === q, b.detectDuplicates = !!k, O(), b.sortDetached = r(function (e) {
                                ...
                                var a = this,
                                    ...
                                    p = function () {
                                        ...
                                        if (!(t < s)) {
                                            ...
                                            p = e && ("object" == typeof e || "function" == typeof e) && e.then, de.isFunction(p) ? r ? p.call(e, o(s, n, l, r), o(s, n, c, r)) : (s++, p.call(e, o(s, n, l, r), o(s, n, c, r), o(s, n, l, n.notifyWith))) : (i !== l && (a = void 0, u = [e]), (r || n.resolveWith)(a, u))
                                        }
                                    },
                                    f = r ? p : function () {
                                        try {
    ...
    }), de.ready.then = Ne.then, "complete" === te.readyState || "loading" !== te.readyState && !te.documentElement.doScroll ? e.setTimeout(de.ready) : (te.addEventListener("DOMContentLoaded", p), e.addEventListener("load", p));
    var De = function (e, t, n, i, r, o, s) {
            ...
            } else if (void 0 !== i && (r = !0, de.isFunction(i) || (s = !0), c && (s ? (t.call(e, i), t = null) : (c = t, t = function (e, t, n) {
    ...
    de.event = {
        ...
        add: function (e, t, n, i, r) {
            var o, s, a, l, c, u, p, f, h, d, y, m = Ie.get(e);
            if (m)
                for (n.handler && (o = n, n = o.handler, r = o.selector), r && de.find.matchesSelector(Qe, r), n.guid || (n.guid = de.guid++), (l = m.events) || (l = m.events = {}), (s = m.handle) || (s = m.handle = function (t) {
                    ...
                    }), c = (t = (t || "").match(ke) || [""]).length; c--;) a = Je.exec(t[c]) || [], h = y = a[1], d = (a[2] || "").split(".").sort(), h && (p = de.event.special[h] || {}, h = (r ? p.delegateType : p.bindType) || h, p = de.event.special[h] || {}, u = de.extend({
                    type: h,
                    origType: y,
                    data: i,
                    handler: n,
                    ...
                    namespace: d.join(".")
                }, o), (f = l[h]) || (f = l[h] = [], f.delegateCount = 0, p.setup && !1 !== p.setup.call(e, i, d, s) || e.addEventListener && e.addEventListener(h, s)), p.add && (p.add.call(e, u), u.handler.guid || (u.handler.guid = n.guid)), r ? f.splice(f.delegateCount++, 0, u) : f.push(u), de.event.global[h] = !0)
        },
        remove: function (e, t, n, i, r) {
            var o, s, a, l, c, u, p, f, h, d, y, m = Ie.hasData(e) && Ie.get(e);
            if (m && (l = m.events)) {
                for (c = (t = (t || "").match(ke) || [""]).length; c--;)
                    if (a = Je.exec(t[c]) || [], h = y = a[1], d = (a[2] || "").split(".").sort(), h) {
                        for (p = de.event.special[h] || {}, f = l[h = (i ? p.delegateType : p.bindType) || h] || [], a = a[2] && new RegExp("(^|\\.)" + d.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = o = f.length; o--;) u = f[o], !r && y !== u.origType || n && n.guid !== u.guid || a && !a.test(u.namespace) || i && i !== u.selector && ("**" !== i || !u.selector) || (f.splice(o, 1), u.selector && f.delegateCount--, p.remove && p.remove.call(e, u));
                        s && !f.length && (p.teardown && !1 !== p.teardown.call(e, d, m.handle) || de.removeEvent(e, h, m.handle), delete l[h])
                    } else
                        for (h in l) de.event.remove(e, h + t[c], n, i, !0);
                de.isEmptyObject(l) && Ie.remove(e, "handle events")
            }
        },
        dispatch: function (e) {
            var t, n, i, r, o, s, a = de.event.fix(e),
            ...
            if (a.delegateTarget = this, !u.preDispatch || !1 !== u.preDispatch.call(this, a)) {
                for (s = de.event.handlers.call(this, a, c), t = 0;
                    ...
                    for (a.currentTarget = r.elem, n = 0;
                        (o = r.handlers[n++]) && !a.isImmediatePropagationStopped();) a.rnamespace && !a.rnamespace.test(o.namespace) || (a.handleObj = o, a.data = o.data, void 0 !== (i = ((de.event.special[o.origType] || {}).handle || o.handler).apply(r.elem, l)) && !1 === (a.result = i) && (a.preventDefault(), a.stopPropagation()));
        ...
        return this instanceof de.Event ? (e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? w : _, this.target = e.target && 3 === e.target.nodeType ? e.target.parentNode : e.target, this.currentTarget = e.currentTarget, this.relatedTarget = e.relatedTarget) : this.type = e, t && de.extend(this, t), this.timeStamp = e && e.timeStamp || de.now(), void(this[de.expando] = !0)) : new de.Event(e, t)
    }, de.Event.prototype = {
    ...
    de.extend({
        ...
        clone: function (e, t, n) {
            ...
            if (!(fe.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || de.isXMLDoc(e)))
                for (s = v(a), o = v(e), i = 0, r = o.length; i < r; i++) k(o[i], s[i]);
            if (t)
                if (n)
                    for (o = o || v(e), s = s || v(a), i = 0, r = o.length; i < r; i++) A(o[i], s[i]);
                else A(e, a);
        ...
        style: function (e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var r, o, s, a = de.camelCase(t),
                    l = lt.test(t),
                    c = e.style;
                return l || (t = L(a)), s = de.cssHooks[t] || de.cssHooks[a], void 0 === n ? s && "get" in s && void 0 !== (r = s.get(e, !1, i)) ? r : c[t] : ("string" === (o = typeof n) && (r = Re.exec(n)) && r[1] && (n = y(e, t, r), o = "number"), void(null != n && n === n && ("number" === o && (n += r && r[3] || (de.cssNumber[a] ? "" : "px")), fe.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (c[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, i)) || (l ? c.setProperty(t, n) : c[t] = n))))
            }
        },
        css: function (e, t, n, i) {
            var r, o, s, a = de.camelCase(t);
            return lt.test(t) || (t = L(a)), (s = de.cssHooks[t] || de.cssHooks[a]) && "get" in s && (r = s.get(e, !0, n)), void 0 === r && (r = D(e, t, i)), "normal" === r && t in ut && (r = ut[t]), "" === n || n ? (o = parseFloat(r), !0 === n || isFinite(o) ? o || 0 : r) : r
        }
    }), de.each(["height", "width"], function (e, t) {
        de.cssHooks[t] = {
            get: function (e, n, i) {
                if (n) return !at.test(de.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? q(e, t, i) : We(e, ct, function () {
                    return q(e, t, i)
                })
            },
            set: function (e, n, i) {
    ...
    de.Animation = de.extend(V, {
            ...
            prefilters: [function (e, t, n) {
                var i, r, o, s, a, l, c, u, p = "width" in t || "height" in t,
                    f = this,
                    h = {},
                    d = e.style,
                    y = e.nodeType && ze(e),
                    m = Ie.get(e, "fxshow");
                n.queue || (null == (s = de._queueHooks(e, "fx")).unqueued && (s.unqueued = 0, a = s.empty.fire, s.empty.fire = function () {
                    s.unqueued || a()
                ...
                for (i in t)
                    ...
                    p && 1 === e.nodeType && (n.overflow = [d.overflow, d.overflowX, d.overflowY], null == (c = m && m.display) && (c = Ie.get(e, "display")), "none" === (u = de.css(e, "display")) && (c ? u = c : (g([e], !0), c = e.style.display || c, u = de.css(e, "display"), g([e]))), ("inline" === u || "inline-block" === u && null != c) && "none" === de.css(e, "float") && (l || (f.done(function () {
                        d.display = c
                    }), null == c && (u = d.display, c = "none" === u ? "" : u)), d.display = "inline-block")), n.overflow && (d.overflow = "hidden", f.always(function () {
                        d.overflow = n.overflow[0], d.overflowX = n.overflow[1], d.overflowY = n.overflow[2]
                    })), l = !1;
                    for (i in h) l || (m ? "hidden" in m && (y = m.hidden) : m = Ie.access(e, "fxshow", {
                        display: c
                    }), o && (m.hidden = !y), y && g([e], !0), f.done(function () {
                        y || g([e]), Ie.remove(e, "fxshow");
                        for (i in h) de.style(e, i, h[i])
                    })), l = U(y ? m[i] : 0, i, f), i in m || (m[i] = l.start, y && (l.end = l.start, l.start = 0))
                }
            }],
            ...
            return de.fx.off ? i.duration = 0 : "number" != typeof i.duration && (i.duration in de.fx.speeds ? i.duration = de.fx.speeds[i.duration] : i.duration = de.fx.speeds._default), null != i.queue && !0 !== i.queue || (i.queue = "fx"), i.old = i.complete, i.complete = function () {
                de.isFunction(i.old) && i.old.call(this), i.queue && de.dequeue(this, i.queue)
            }, i
        }, de.fn.extend({
            fadeTo: function (e, t, n, i) {
                return this.filter(ze).css("opacity", 1).show().end().animate({
                    opacity: t
                }, e, n, i)
            },
    ...
    de.fn.extend({
        ...
        attr: function (e, t, n) {
            ...
            if (3 !== o && 8 !== o && 2 !== o) return void 0 === e.getAttribute ? de.prop(e, t, n) : (1 === o && de.isXMLDoc(e) || (r = de.attrHooks[t.toLowerCase()] || (de.expr.match.bool.test(t) ? gt : void 0)), void 0 !== n ? null === n ? void de.removeAttr(e, t) : r && "set" in r && void 0 !== (i = r.set(e, n, t)) ? i : (e.setAttribute(t, n + ""), n) : r && "get" in r && null !== (i = r.get(e, t)) ? i : null == (i = de.find.attr(e, t)) ? void 0 : i)
        },
        attrHooks: {
            type: {
                set: function (e, t) {
    ...
    de.fn.extend({
        ...
        toggleClass: function (e, t) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : de.isFunction(e) ? this.each(function (n) {
                ...
                var t, i, r, o;
                if ("string" === n)
                    for (i = 0, r = de(this), o = e.match(ke) || []; t = o[i++];) r.hasClass(t) ? r.removeClass(t) : r.addClass(t);
        ...
        hasClass: function (e) {
            var t, n, i = 0;
            for (t = " " + e + " "; n = this[i++];)
                if (1 === n.nodeType && (" " + $(K(n)) + " ").indexOf(t) > -1) return !0;
            return !1
        }
    });
    var wt = /\r/g;
    de.fn.extend({
        val: function (e) {
            ...
            return arguments.length ? (i = de.isFunction(e), this.each(function (n) {
                var r;
                1 === this.nodeType && (null == (r = i ? e.call(this, n, de(this).val()) : e) ? r = "" : "number" == typeof r ? r += "" : Array.isArray(r) && (r = de.map(r, function (e) {
                    return null == e ? "" : e + ""
                })), (t = de.valHooks[this.type] || de.valHooks[this.nodeName.toLowerCase()]) && "set" in t && void 0 !== t.set(this, r, "value") || (this.value = r))
            })) : r ? (t = de.valHooks[r.type] || de.valHooks[r.nodeName.toLowerCase()]) && "get" in t && void 0 !== (n = t.get(r, "value")) ? n : "string" == typeof (n = r.value) ? n.replace(wt, "") : null == n ? "" : n : void 0
        }
    }), de.extend({
        valHooks: {
            option: {
    ...
    de.extend(de.event, {
        trigger: function (t, n, i, r) {
            var o, s, a, l, c, u, p, f = [i || te],
                h = ce.call(t, "type") ? t.type : t,
                d = ce.call(t, "namespace") ? t.namespace.split(".") : [];
            if (s = a = i = i || te, 3 !== i.nodeType && 8 !== i.nodeType && !_t.test(h + de.event.triggered) && (h.indexOf(".") > -1 && (d = h.split("."), h = d.shift(), d.sort()), c = h.indexOf(":") < 0 && "on" + h, t = t[de.expando] ? t : new de.Event(h, "object" == typeof t && t), t.isTrigger = r ? 2 : 3, t.namespace = d.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + d.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : de.makeArray(n, [t]), p = de.event.special[h] || {}, r || !p.trigger || !1 !== p.trigger.apply(i, n))) {
                ...
                for (o = 0;
                    (s = f[o++]) && !t.isPropagationStopped();) t.type = o > 1 ? l : p.bindType || h, (u = (Ie.get(s, "events") || {})[t.type] && Ie.get(s, "handle")) && u.apply(s, n), (u = c && s[c]) && u.apply && Me(s) && (t.result = u.apply(s, n), !1 === t.result && t.preventDefault());
                return t.type = h, r || t.isDefaultPrevented() || p._default && !1 !== p._default.apply(f.pop(), n) || !Me(i) || c && de.isFunction(i[h]) && !de.isWindow(i) && ((a = i[c]) && (i[c] = null), de.event.triggered = h, i[h](), de.event.triggered = void 0, a && (i[c] = a)), t.result
            }
        },
    ...
    Ft.href = Et.href, de.extend({
        ...
        ajax: function (t, n) {
            function i(t, n, i, a) {
                var c, f, h, b, w, _ = n;
                u || (u = !0, l && e.clearTimeout(l), r = void 0, s = a || "", E.readyState = t > 0 ? 4 : 0, c = t >= 200 && t < 300 || 304 === t, i && (b = J(d, E, i)), b = Z(d, b, E, c), c ? (d.ifModified && ((w = E.getResponseHeader("Last-Modified")) && (de.lastModified[o] = w), (w = E.getResponseHeader("etag")) && (de.etag[o] = w)), 204 === t || "HEAD" === d.type ? _ = "nocontent" : 304 === t ? _ = "notmodified" : (_ = b.state, f = b.data, h = b.error, c = !h)) : (h = _, !t && _ || (_ = "error", t < 0 && (t = 0))), E.status = t, E.statusText = (n || _) + "", c ? g.resolveWith(y, [f, _, E]) : g.rejectWith(y, [E, _, h]), E.statusCode(x), x = void 0, p && m.trigger(c ? "ajaxSuccess" : "ajaxError", [E, d, c ? f : h]), v.fireWith(y, [E, _]), p && (m.trigger("ajaxComplete", [E, d]), --de.active || de.event.trigger("ajaxStop")))
            }
            "object" == typeof t && (n = t, t = void 0), n = n || {};
            var r, o, s, a, l, c, u, p, f, h, d = de.ajaxSetup({}, n),
                y = d.context || d,
            ...
            if (g.promise(E), d.url = ((t || d.url || Et.href) + "").replace(Ht, Et.protocol + "//"), d.type = n.method || n.type || d.method || d.type, d.dataTypes = (d.dataType || "*").toLowerCase().match(ke) || [""], null == d.crossDomain) {
            ...
            (p = de.event && d.global) && 0 == de.active++ && de.event.trigger("ajaxStart"), d.type = d.type.toUpperCase(), d.hasContent = !Lt.test(d.type), o = d.url.replace(Nt, ""), d.hasContent ? d.data && d.processData && 0 === (d.contentType || "").indexOf("application/x-www-form-urlencoded") && (d.data = d.data.replace(Ot, "+")) : (h = d.url.slice(o.length), d.data && (o += (Ct.test(o) ? "&" : "?") + d.data, delete d.data), !1 === d.cache && (o = o.replace(Dt, "$1"), h = (Ct.test(o) ? "&" : "?") + "_=" + Tt++ + h), d.url = o + h), d.ifModified && (de.lastModified[o] && E.setRequestHeader("If-Modified-Since", de.lastModified[o]), de.etag[o] && E.setRequestHeader("If-None-Match", de.etag[o])), (d.data && d.hasContent && !1 !== d.contentType || n.contentType) && E.setRequestHeader("Content-Type", d.contentType), E.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + Rt + "; q=0.01" : "") : d.accepts["*"]);
    ...
    fe.cors = !!Wt && "withCredentials" in Wt, fe.ajax = Wt = !!Wt, de.ajaxTransport(function (t) {
        var n, i;
        if (fe.cors || Wt && !t.crossDomain) return {
            send: function (r, o) {
                ...
                n = function (e) {
                    return function () {
                        n && (n = i = a.onload = a.onerror = a.onabort = a.onreadystatechange = null, "abort" === e ? a.abort() : "error" === e ? "number" != typeof a.status ? o(0, "error") : o(a.status, a.statusText) : o(zt[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? {
                            binary: a.response
                        } : {
                            text: a.responseText
    ...
    de.ajaxSetup({
        ...
        if (a || "jsonp" === t.dataTypes[0]) return r = t.jsonpCallback = de.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, a ? t[a] = t[a].replace(Bt, "$1" + r) : !1 !== t.jsonp && (t.url += (Ct.test(t.url) ? "&" : "?") + t.jsonp + "=" + r), t.converters["script json"] = function () {
        ...
        var i, r, o;
        return t || (fe.createHTMLDocument ? (t = te.implementation.createHTMLDocument(""), i = t.createElement("base"), i.href = te.location.href, t.head.appendChild(i)) : t = te), r = Ee.exec(e), o = !n && [], r ? [t.createElement(r[1])] : (r = b([e], t, o), o && o.length && de(o).remove(), de.merge([], r.childNodes))
    }, de.fn.load = function (e, t, n) {
        var i, r, o, s = this,
            a = e.indexOf(" ");
        return a > -1 && (i = $(e.slice(a)), e = e.slice(0, a)), de.isFunction(t) ? (n = t, t = void 0) : t && "object" == typeof t && (r = "POST"), s.length > 0 && de.ajax({
            url: e,
            type: r || "GET",
            dataType: "html",
            data: t
        ...
        setOffset: function (e, t, n) {
            var i, r, o, s, a, l, c = de.css(e, "position"),
                u = de(e),
                p = {};
            "static" === c && (e.style.position = "relative"), a = u.offset(), o = de.css(e, "top"), l = de.css(e, "left"), ("absolute" === c || "fixed" === c) && (o + l).indexOf("auto") > -1 ? (i = u.position(), s = i.top, r = i.left) : (s = parseFloat(o) || 0, r = parseFloat(l) || 0), de.isFunction(t) && (t = t.call(e, n, de.extend({}, a))), null != t.top && (p.top = t.top - a.top + s), null != t.left && (p.left = t.left - a.left + r), "using" in t ? t.using.call(e, p) : u.css(p)
        }
    }, de.fn.extend({
        offset: function (e) {
        ...
        position: function () {
            if (this[0]) {
                ...
                return "fixed" === de.css(n, "position") ? t = n.getBoundingClientRect() : (e = this.offsetParent(), t = this.offset(), r(e[0], "html") || (i = e.offset()), i = {
    ...
    }, de.isArray = Array.isArray, de.parseJSON = JSON.parse, de.nodeName = r, "function" == typeof define && define.amd && define("jquery", [], function () {
        return de
    });
    var Vt = e.jQuery,
        $t = e.$;
...
function (e, t) {
    ...
    function S(t, n, i) {
        return (void 0 === i ? t : t.slice(0, j(t, "name", i))).forEach(function (t) {
    ...
    function A() {
        if (!this.state.isDestroyed) {
            ...
            e.offsets.reference = w(this.state, this.popper, this.reference), e.placement = b(this.options.placement, e.offsets.reference, this.popper, this.reference, this.options.modifiers.flip.boundariesElement, this.options.modifiers.flip.padding), e.originalPlacement = e.placement, e.offsets.popper = T(this.popper, e.offsets.reference, e.placement), e.offsets.popper.position = "absolute", e = S(this.modifiers, e), this.state.isCreated ? this.options.onUpdate(e) : (this.state.isCreated = !0, this.options.onCreate(e))
        }
    }
    ...
    function D(e, t, n, r) {
        ...
        s.addEventListener(t, n, {
            passive: !0
        }), o || D(i(s.parentNode), t, n, r), r.push(s)
    }
            ...
            offset: {
                ...
                fn: function (e, t) {
                    var n, i = t.offset,
                        ...
                        a = o.reference,
                        l = r.split("-")[0];
                    return n = P(+i) ? [+i, 0] : B(i, s, a, l), "left" === l ? (s.top += n[0], s.left -= n[1]) : "right" === l ? (s.top += n[0], s.left += n[1]) : "top" === l ? (s.left += n[0], s.top -= n[1]) : "bottom" === l && (s.left += n[0], s.top += n[1]), e.popper = s, e
                },
                offset: 0
            },
            preventOverflow: {
            ...
            flip: {
                ...
                fn: function (e, t) {
                    ...
                    return s.forEach(function (a, l) {
                        ...
                        (f || g || x) && (e.flipped = !0, (f || g) && (i = s[l + 1]), x && (o = z(o)), e.placement = i + (o ? "-" + o : ""), e.offsets.popper = oe({}, e.offsets.popper, T(e.instance.popper, e.offsets.reference, e.placement)), e = S(e.instance.modifiers, e, "flip"))
                    }), e
                },
                behavior: "flip",
                padding: 5,
            ...
            computeStyle: {
                ...
                fn: function (e, t) {
                    ...
                    var a, l, c = void 0 === s ? t.gpuAcceleration : s,
                        ...
                        m = O("transform");
                    if (l = "bottom" == h ? -u.height + f.bottom : f.top, a = "right" == y ? -u.width + f.right : f.left, c && m) p[m] = "translate3d(" + a + "px, " + l + "px, 0)", p[h] = 0, p[y] = 0, p.willChange = "transform";
                    else {
                        var g = "bottom" == h ? -1 : 1,
                            v = "right" == y ? -1 : 1;
...
function (e, t) {
    ...
    function s(e, t, n) {
        ...
        for (var i = (new window.DOMParser).parseFromString(e, "text/html"), r = Object.keys(t), o = [].slice.call(i.body.querySelectorAll("*")), s = 0, a = o.length; s < a; s++) ! function (e, n) {
            var i = o[e],
    ...
    t(document).on(h.CLICK_DATA_API, '[data-dismiss="alert"]', d._handleDismiss(new d)), t.fn[c] = d._jQueryInterface, t.fn[c].Constructor = d, t.fn[c].noConflict = function () {
    ...
    }), t.fn[y] = T._jQueryInterface, t.fn[y].Constructor = T, t.fn[y].noConflict = function () {
    ...
    var C = "carousel",
        ...
        R = function () {
            ...
            return n.next = function () {
                ...
                t(this._element).off(S), t.removeData(this._element, j), this._items = null, this._config = null, this._element = null, this._interval = null, this._isPaused = null, this._isSliding = null, this._activeElement = null, this._indicatorsElement = null
                ...
                if (o = e === D ? (i = "carousel-item-left", r = "carousel-item-next", "left") : (i = "carousel-item-right", r = "carousel-item-prev", "right"), u && t(u).hasClass(L)) this._isSliding = !1;
                    ...
                    if (t(this._element).hasClass("slide")) {
                        ...
                        t(a).one(l.TRANSITION_END, function () {
                            t(u).removeClass(i + " " + r).addClass(L), t(a).removeClass(L + " " + r + " " + i), s._isSliding = !1, setTimeout(function () {
    ...
    }), t.fn[F] = J._jQueryInterface, t.fn[F].Constructor = J, t.fn[F].noConflict = function () {
    ...
    var Z = "dropdown",
        ...
        he = function () {
            ...
            return i.toggle = function () {
                if (!this._element.disabled && !t(this._element).hasClass(se)) {
                    ...
                    if (e._clearMenus(), !r) {
                        ...
                        if (t(i).trigger(s), !s.isDefaultPrevented()) {
                            ...
                            "ontouchstart" in document.documentElement && 0 === t(i).closest(".navbar-nav").length && t(document.body).children().on("mouseover", null, t.noop), this._element.focus(), this._element.setAttribute("aria-expanded", !0), t(this._menu).toggleClass(ae), t(i).toggleClass(ae).trigger(t.Event(oe.SHOWN, o))
                        }
                    }
                }
            }, i.show = function () {
                    ...
                    for (var i = [].slice.call(document.querySelectorAll(ce)), r = 0, o = i.length; r < o; r++) {
                        ...
                        if (n && "click" === n.type && (l.clickEvent = n), a) {
                            ...
                            if (t(s).hasClass(ae) && !(n && ("click" === n.type && /input|textarea/i.test(n.target.tagName) || "keyup" === n.type && 9 === n.which) && t.contains(s, n.target))) {
                                ...
                                t(s).trigger(u), u.isDefaultPrevented() || ("ontouchstart" in document.documentElement && t(document.body).children().off("mouseover", null, t.noop), i[r].setAttribute("aria-expanded", "false"), t(c).removeClass(ae), t(s).removeClass(ae).trigger(t.Event(oe.HIDDEN, l)))
                            }
                        }
                    }
                ...
                if ((/input|textarea/i.test(n.target.tagName) ? !(32 === n.which || 27 !== n.which && (40 !== n.which && 38 !== n.which || t(n.target).closest(ue).length)) : re.test(n.which)) && (n.preventDefault(), n.stopPropagation(), !this.disabled && !t(this).hasClass(se))) {
        ...
        Se = function () {
            ...
            return n.toggle = function (e) {
                ...
                [window, this._element, this._dialog].forEach(function (e) {
                    return t(e).off(me)
                }), t(document).off(be.FOCUSIN), t.removeData(this._element, ye), this._config = null, this._element = null, this._dialog = null, this._backdrop = null, this._isShown = null, this._isBodyOverflowing = null, this._ignoreBackdropClick = null, this._isTransitioning = null, this._scrollbarWidth = null
                ...
                this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), this._element.setAttribute("aria-modal", !0), t(this._dialog).hasClass("modal-dialog-scrollable") ? this._dialog.querySelector(".modal-body").scrollTop = 0 : this._element.scrollTop = 0, i && l.reflow(this._element), t(this._element).addClass(Ee), this._config.focus && this._enforceFocus();
                ...
                if (this._isShown && this._config.backdrop) {
                    if (this._backdrop = document.createElement("div"), this._backdrop.className = "modal-backdrop", i && this._backdrop.classList.add(i), t(this._backdrop).appendTo(document.body), t(this._element).on(be.CLICK_DISMISS, function (e) {
                        ...
                        }), i && l.reflow(this._backdrop), t(this._backdrop).addClass(Ee), !e) return;
                    if (!i) return void e();
        ...
        Xe = function () {
            ...
            return i.enable = function () {
                ...
                if (this.isWithContent() && this._isEnabled) {
                    ...
                    t(s).data(this.constructor.DATA_KEY, this), t.contains(this.element.ownerDocument.documentElement, this.tip) || t(s).appendTo(p), t(this.element).trigger(this.constructor.Event.INSERTED), this._popper = new n(this.element, s, {
                        placement: u,
                        modifiers: {
                            offset: this._getOffset(),
                            flip: {
                    ...
                    }), t(s).addClass(Ve), "ontouchstart" in document.documentElement && t(document.body).children().on("mouseover", null, t.noop);
                    var f = function () {
                ...
                if (t(this.element).trigger(r), !r.isDefaultPrevented()) {
                    if (t(i).removeClass(Ve), "ontouchstart" in document.documentElement && t(document.body).children().off("mouseover", null, t.noop), this._activeTrigger.click = !1, this._activeTrigger[Ke] = !1, this._activeTrigger[$e] = !1, t(this.tip).hasClass(Be)) {
                ...
                (n = n || t(e.currentTarget).data(i)) || (n = new this.constructor(e.currentTarget, this._getDelegateConfig()), t(e.currentTarget).data(i, n)), e && (n._activeTrigger["focusin" === e.type ? Ke : $e] = !0), t(n.getTipElement()).hasClass(Ve) || n._hoverState === We ? n._hoverState = We : (clearTimeout(n._timeout), n._hoverState = We, n.config.delay && n.config.delay.show ? n._timeout = setTimeout(function () {
                    n._hoverState === We && n.show()
                }, n.config.delay.show) : n.show())
            }, i._leave = function (e, n) {
                var i = this.constructor.DATA_KEY;
                (n = n || t(e.currentTarget).data(i)) || (n = new this.constructor(e.currentTarget, this._getDelegateConfig()), t(e.currentTarget).data(i, n)), e && (n._activeTrigger["focusout" === e.type ? Ke : $e] = !1), n._isWithActiveTrigger() || (clearTimeout(n._timeout), n._hoverState = "out", n.config.delay && n.config.delay.hide ? n._timeout = setTimeout(function () {
                ...
                return Object.keys(n).forEach(function (e) {
                    ...
                    show: e.delay,
                    hide: e.delay
                }), "number" == typeof e.title && (e.title = e.title.toString()), "number" == typeof e.content && (e.content = e.content.toString()), l.typeCheckConfig(De, e, this.constructor.DefaultType), e.sanitize && (e.template = s(e.template, e.whiteList, e.sanitizeFn)), e
    ...
    t.fn[Qe] = rt._jQueryInterface, t.fn[Qe].Constructor = rt, t.fn[Qe].noConflict = function () {
    ...
    var ot = "scrollspy",
        ...
        vt = function () {
            function e(e, n) {
                var i = this;
                this._element = e, this._scrollElement = "BODY" === e.tagName ? window : e, this._config = this._getConfig(n), this._selector = this._config.target + " " + dt + "," + this._config.target + " " + yt + "," + this._config.target + " " + mt, this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, t(this._scrollElement).on(pt.SCROLL, function (e) {
                    return i._process(e)
            ...
            return n.refresh = function () {
                ...
                i.hasClass("dropdown-item") ? (i.closest(".dropdown").find(".dropdown-toggle").addClass(ft), i.addClass(ft)) : (i.addClass(ft), i.parents(ht).prev(dt + ", " + yt).addClass(ft), i.parents(ht).prev(".nav-item").children(dt).addClass(ft)), t(this._scrollElement).trigger(pt.ACTIVATE, {
                    relatedTarget: e
                })
            }, n._clear = function () {
    ...
    }), t.fn.tab = jt._jQueryInterface, t.fn.tab.Constructor = jt, t.fn.tab.noConflict = function () {
    ...
    var St = "toast",
        ...
        Ht = function () {
            ...
            return n.show = function () {
                ...
                var n = this;
                this._element.classList.contains(Dt) && (t(this._element).trigger(Nt.HIDE), e ? this._close() : this._timeout = setTimeout(function () {
                    n._close()
                }, this._config.delay))
            }, n.dispose = function () {
                clearTimeout(this._timeout), this._timeout = null, this._element.classList.contains(Dt) && this._element.classList.remove(Dt), t(this._element).off(Nt.CLICK_DISMISS), t.removeData(this._element, At), this._element = null, this._config = null
            }, n._getConfig = function (e) {
    ...
    t.fn[St] = Ht._jQueryInterface, t.fn[St].Constructor = Ht, t.fn[St].noConflict = function () {
        ...
        }(), e.Util = l, e.Alert = d, e.Button = T, e.Carousel = R, e.Collapse = J, e.Dropdown = he, e.Modal = Se, e.Popover = rt, e.Scrollspy = vt, e.Tab = jt, e.Toast = Ht, e.Tooltip = Xe, Object.defineProperty(e, "__esModule", {
            value: !0
        })
}),
function (e) {
    ...
    return function () {
            ...
            var i = e("./lib/execute-scripts.js"),
                ...
                d = function (e) {
                    this.state = {
                        ...
                        href: null,
                        options: null
                    }, this.options = o(e), this.log("Pjax options", this.options), this.options.scrollRestoration && "scrollRestoration" in history && (history.scrollRestoration = "manual"), this.maxUid = this.lastUid = a(), this.parseDOM(document), l(window, "popstate", function (e) {
                        if (e.state) {
            ...
            if (d.switches = s, d.prototype = {
                    ...
                    loadContent: function (e, t) {
                        var n = document.implementation.createHTMLDocument("pjax"),
                            ...
                            r = /\s?[a-z:]+(?:\=(?:\'|\")[^\'\">]+(?:\'|\"))*/gi,
                            o = e.match(i);
                        if (o && o.length && (o = o[0].match(r)).length && (o.shift(), o.forEach(function (e) {
                                var t = e.trim().split("=");
                                1 === t.length ? n.documentElement.setAttribute(t[0], !0) : n.documentElement.setAttribute(t[0], t[1].slice(1, -1))
                            })), n.documentElement.innerHTML = e, this.log("load content", n.documentElement.attributes, n.documentElement.innerHTML.length), document.activeElement && p(document, this.options.selectors, document.activeElement)) try {
                    ...
                    loadUrl: function (e, t) {
                        t = "object" == typeof t ? f({}, this.options, t) : u(this.options), this.log("load href", e, t), this.abortRequest(this.request), c(document, "pjax:send", t), this.request = this.doRequest(e, t, this.handleResponse.bind(this))
                    },
                ...
                }, d.isSupported = e("./lib/is-supported.js"), d.isSupported()) t.exports = d;
            else {
                var y = h;
        ...
        3: [function (e, t, n) {
            t.exports = function (e) {
                ...
                if (t.match("document.write")) return console && console.log && console.log("Script contains document.write. Canâ€™t be executed correctly. Code skipped ", e), !1;
                if (r.type = "text/javascript", "" !== n && (r.src = n, r.async = !1), "" !== t) try {
        ...
        11: [function (e, t, n) {
                    ...
                    if (!Number.isNaN(Number(n))) {
                        ...
                        if (i.name && void 0 !== i.attributes && "button" !== r) {
                            ...
                            if (!o || "checkbox" !== o.value && "radio" !== o.value || i.checked) {
                                var s = [];
                                if ("select" === r)
                                    for (var a, l = 0; l < i.options.length; l++)(a = i.options[l]).selected && s.push(a.value || a.text);
                                else s.push(i.value);
            ...
            var o = e("../events/on"),
                ...
                a = function (e, t) {
                    if (!l(t)) {
                        ...
                        var a = r(o, n);
                        a ? e.setAttribute("data-pjax-state", a) : (t.preventDefault(), "multipart/form-data" === e.enctype ? n.requestOptions.formData = new FormData(e) : n.requestOptions.requestParams = i(e), e.setAttribute("data-pjax-state", "submit"), n.triggerElement = e, this.loadUrl(o.href, n))
                    }
                },
                l = function (e) {
            ...
            t.exports = function (e) {
                var t = this;
                e.setAttribute("data-pjax-state", ""), o(e, "submit", function (n) {
                    a.call(t, e, n)
        ...
        12: [function (e, t, n) {
            ...
            t.exports = function (e) {
                var t = this;
                e.setAttribute(s, ""), r(e, "click", function (n) {
                    a.call(t, e, n)
        ...
        16: [function (e, t, n) {
            ...
            t.exports = function (e, t, n) {
                ...
                if (u.onreadystatechange = function () {
                        ...
                        n(null, u, e, t)
                    }, a && a.length) switch (r = a.map(function (e) {
                ...
                return t.cacheBust && (e = i(e, "t", Date.now())), u.open(s, e, !0), u.timeout = p, u.setRequestHeader("X-Requested-With", "XMLHttpRequest"), u.setRequestHeader("X-PJAX", "true"), u.setRequestHeader("X-PJAX-Selectors", JSON.stringify(t.selectors)), c && "POST" === s && u.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"), u.send(c), u
            }
        }, {
        ...
        17: [function (e, t, n) {
            ...
            t.exports = function (e, t, n, o, s, a) {
                ...
                n.forEach(function (n) {
                    ...
                    if (this.log && this.log("Pjax switch", n, c, u), c.length !== u.length) throw "DOM doesnâ€™t look the same on new loaded page: â€™" + n + "â€™ - new " + c.length + ", old " + u.length;
                    i(c, function (i, o) {
                        var s = u[o];
            ...
            t.exports = {
                ...
                switchElementsAlt: function (e, t) {
                    if (e.innerHTML = t.innerHTML, t.hasAttributes())
                        for (var n = t.attributes, i = 0; i < n.length; i++) e.attributes.setNamedItem(n[i].cloneNode());
                    this.onSwitch()
                },
                ...
                sideBySide: function (e, t, n, r) {
                    ...
                    r = r || {}, o.call(e.childNodes, function (e) {
                        s.push(e), e.classList && !e.classList.contains("js-Pjax-remove") && (e.hasAttribute("data-pjax-classes") && (e.className = e.className.replace(e.getAttribute("data-pjax-classes"), ""), e.removeAttribute("data-pjax-classes")), e.classList.add("js-Pjax-remove"), r.callbacks && r.callbacks.removeElement && r.callbacks.removeElement(e), r.classNames && (e.className += " " + r.classNames.remove + " " + (n.backward ? r.classNames.backward : r.classNames.forward)), u++, i(e, c, p, !0))
                    }), o.call(t.childNodes, function (e) {
                        if (e.classList) {
                            var t = "";
                            r.classNames && (t = " js-Pjax-add " + r.classNames.add + " " + (n.backward ? r.classNames.forward : r.classNames.backward)), r.callbacks && r.callbacks.addElement && r.callbacks.addElement(e), e.className += t, e.setAttribute("data-pjax-classes", t), a.push(e), l.appendChild(e), u++, i(e, c, p, !0)
                        }
...
function (e) {
    ...
    e(document).on("pjax:send", function () {
        ...
        }).emulateTransitionEnd(600) : (e(document).trigger("pjaxEnd"), e(".js-Pjax-onswitch").removeClass("js-Pjax-onswitch"))
    });
    var t = {
            classNames: {
            ...
            callbacks: {
                addElement: function (t) {
                    e(t).parent().addClass("js-Pjax-onswitch"), e(document).delay(10).queue(function () {
...
var MODULE_CONFIG = {
        ...
        chartist: ["../libs/chartist/dist/chartist.min.css", "../libs/chartist/dist/chartist.min.js", "../libs/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.min.js", "../libs/chartist/dist/chartist.ext.js", "../assets/js/plugins/chartist.js"],
        ...
        bootstrapTable: ["../libs/bootstrap-table/dist/bootstrap-table.min.js", "../libs/bootstrap-table/dist/extensions/export/bootstrap-table-export.min.js", "../libs/bootstrap-table/dist/extensions/mobile/bootstrap-table-mobile.min.js", "../assets/js/plugins/tableExport.min.js", "../assets/js/plugins/bootstrap-table.js"],
        ...
        fullCalendar: ["../libs/moment/min/moment-with-locales.min.js", "../libs/fullcalendar/dist/fullcalendar.min.js", "../libs/fullcalendar/dist/fullcalendar.min.css", "../libs/notie/dist/notie.min.js", "../assets/js/plugins/notie.js", "../assets/js/app/calendar.js"],
        ...
        vectorMap: ["../libs/jqvmap/dist/jqvmap.min.css", "../libs/jqvmap/dist/jquery.vmap.js", "../libs/jqvmap/dist/maps/jquery.vmap.world.js", "../libs/jqvmap/dist/maps/jquery.vmap.usa.js", "../libs/jqvmap/dist/maps/jquery.vmap.france.js", "../assets/js/plugins/jqvmap.js"],
...
function ($, MODULE_CONFIG, MODULE_OPTION_CONFIG) {
    ...
    $.fn.plugin = function () {
        ...
        return this.each(function () {
            ...
            e[i] && n ? (e[i].apply(e, getOpts(n, i)), t.remove()) : lazyload.load(MODULE_CONFIG[i]).then(function () {
...
function () {
    ...
    function e(n) {
        return void 0 === this || Object.getPrototypeOf(this) !== e.prototype ? new e(n) : (T = this, T.version = "3.3.6", T.tools = new E, T.isSupported() ? (T.tools.extend(T.defaults, n || {}), T.defaults.container = t(T.defaults), T.store = {
            elements: {},
            containers: []
        }, T.sequences = {}, T.history = [], T.uid = 0, T.initialized = !1) : "undefined" != typeof console && console, T)
    }
    ...
    function r(e, t, n) {
        t.container && (t.container = n), e.config ? e.config = T.tools.extendClone(e.config, t) : e.config = T.tools.extendClone(T.defaults, t), "top" === e.config.origin || "bottom" === e.config.origin ? e.config.axis = "Y" : e.config.axis = "X"
    }
    ...
    function h() {
        ...
        f(), T.tools.forOwn(T.store.elements, function (n) {
            t = T.store.elements[n], e = g(t), m(t) ? (t.config.beforeReveal(t.domEl), e ? t.domEl.setAttribute("style", t.styles.inline + t.styles.transform.target + t.styles.transition.delayed) : t.domEl.setAttribute("style", t.styles.inline + t.styles.transform.target + t.styles.transition.instant), y("reveal", t, e), t.revealing = !0, t.seen = !0, t.sequence && d(t, e)) : v(t) && (t.config.beforeReset(t.domEl), t.domEl.setAttribute("style", t.styles.inline + t.styles.transform.initial + t.styles.transition.instant), y("reset", t), t.revealing = !1)
        })
    }
    ...
    function d(e, t) {
        ...
        r.blocked = !0, t && "onload" === e.config.useDelay && (i = e.config.delay), e.sequence.timer && (n = Math.abs(e.sequence.timer.started - new Date), window.clearTimeout(e.sequence.timer)), e.sequence.timer = {
            started: new Date
    ...
    e.prototype.defaults = {
        ...
        a && "number" == typeof a && (g = i(), m = T.sequences[g] = {
            id: g,
            interval: a,
            elemIds: [],
            active: !1
        });
        for (var v = 0; v < h.length; v++)(y = h[v].getAttribute("data-sr-id")) ? d = T.store.elements[y] : (d = {
            id: i(),
            domEl: h[v],
            seen: !1,
            revealing: !1
        }).domEl.setAttribute("data-sr-id", d.id), m && (d.sequence = {
            id: m.id,
            index: m.elemIds.length
        }, m.elemIds.push(d.id)), r(d, s, f), o(d), l(d), T.tools.isMobile() && !d.config.mobile || !T.isSupported() ? (d.domEl.setAttribute("style", d.styles.inline), d.disabled = !0) : d.revealing || d.domEl.setAttribute("style", d.styles.inline + d.styles.transform.initial);
    ...
    return function (e) {
        ...
        var i = n(1),
            ...
            l = function (e, t, n) {
                ...
                for (c in d && (n = t), n) p = ((u = !h && v && void 0 !== v[c]) ? v : n)[c], f = g && u ? a(p, i) : m && "function" == typeof p ? a(Function.call, p) : p, v && s(v, c, p, e & l.U), x[c] != p && o(x, c, f), m && b[c] != p && (b[c] = p)
            };
        ...
        var r = Object.assign || function (e) {
            ...
            l = function () {
                function e(t, n) {
                    ...
                    ! function (e, t) {
                        if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                    }(this, e), this.name = t, this.contents = n, this.tags = i, this.attrs = r({}, a.default, {
        ...
        r(r.S + r.F * !n(37)(function (e) {
            ...
            from: function (e) {
                var t, n, r, p, f = o(e),
                    ...
                    g = 0,
                    v = u(f);
                if (m && (y = i(y, d > 2 ? arguments[2] : void 0, 2)), void 0 == v || h == Array && a(v))
                    for (n = new h(t = l(f.length)); t > g; g++) c(n, g, m ? y(f[g], g) : f[g]);
                else
                    for (p = v.call(f), n = new h; !(r = p.next()).done; g++) c(n, g, m ? s(p, y, [r.value, g], !0) : r.value);
                return n.length = g, n
            }
        })
    }, function (e, t, n) {
        ...
        e.exports = function (e, t, n, d, y, m, g) {
            ...
            if (k && (b = u(k.call(new e))) !== Object.prototype && b.next && (c(b, _, !0), i || "function" == typeof b[p] || s(b, p, h)), E && j && "values" !== j.name && (T = !0, S = function () {
                    return j.call(this)
                }), i && !g || !f && !T && C[p] || s(C, p, S), a[t] = S, a[_] = h, y)
                if (v = {
                        values: E ? S : w("values"),
                        keys: m ? S : w("keys"),
                        entries: A
                    }, g)
                    for (x in v) x in C || o(C, x, v[x]);
...
function (e) {
    ...
    function t() {
        var t = e(".setting"),
            ...
            i = e("#header"),
            r = e("#aside-left");
        n.removeClass(n.attr("data-class")).addClass(theme.setting.bg).attr("data-class", theme.setting.bg), i.removeClass(i.attr("data-class")).addClass(theme.setting.header).attr("data-class", theme.setting.header), r.removeClass(r.attr("data-class")).addClass(theme.setting.aside).attr("data-class", theme.setting.aside), theme.setting.foldedAside ? r.addClass("folded") : r.removeClass("folded"), theme.setting.hideAside ? r.addClass("hide") : r.removeClass("hide"), theme.setting.stickyHeader ? i.addClass("sticky") : i.removeClass("sticky"), theme.setting.stickyAside ? r.addClass("sticky") : r.removeClass("sticky"), t.find('input[name="foldedAside"]').prop("checked", theme.setting.foldedAside), t.find('input[name="hideAside"]').prop("checked", theme.setting.hideAside), t.find('input[name="stickyHeader"]').prop("checked", theme.setting.stickyHeader), t.find('input[name="stickyAside"]').prop("checked", theme.setting.stickyAside), t.find('input[name="bg"][value="' + theme.setting.bg + '"]').prop("checked", !0)
    }
    ...
    /iPhone|iPod|iPad|Silk|Android|BlackBerry|Opera Mini|IEMobile/.test(i) && e("body").addClass("touch"), /iPhone|iPod|iPad/.test(i) && e(document, ".modal, .aside").on("shown.bs.modal", function (t) {
        ...
        t.originalEvent.detail > 0 || t.originalEvent.wheelDelta < 0 ? n.removeClass("scroll-up").addClass("scroll-down") : n.removeClass("scroll-down").addClass("scroll-up"), 0 == e(window).scrollTop() && n.removeClass("scroll-up scroll-down")
    ...
    var r = function () {
        e('[data-toggle="popover"]').popover(), e('[data-toggle="tooltip"]').tooltip(), e(document).find("[data-plugin]").plugin(), sr.reveal(".sr .card, .sr .list-item, .sr .item, .sr .sr-item", {
            afterReveal: function (t) {
                e(t).css("transform", "none").css("transition", "none")
            }
        }, 50), sr.sync(), "undefined" != typeof feather && feather.replace({
            width: 16,
            height: 16
        });
    ...
    window.sr = ScrollReveal(), r(), e(document).on("pjaxEnd", function () {
        r()
